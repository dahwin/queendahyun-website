...
import './App.css';  // Add this line if you created a new CSS file
const LandingPage = () => {
      ...
      <div className="relative z-10">
        ...
        <section id="home" className="pt-24 pb-32">
          <div className="container mx-auto px-6 text-center">
            ...
            <button className="text-white py-3 px-8 rounded-full text-lg font-semibold hover:bg-opacity-80 transition duration-300 transform hover:scale-105 animate-gradient-button">
              Get Started
            </button>
          </div>
        </section>
